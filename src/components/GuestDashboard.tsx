                  ...
                  >
                    ...
                    <div className="space-y-3 pt-4 border-t border-slate-200/50">
                      ...
                      <button
                        ...
                        className="w-full mt-1.5 py-2 bg-slate-50 hover:bg-slate-100 text-slate-700 text-xs font-semibold rounded-xl transition flex items-center justify-center gap-1.5 border border-slate-200 cursor-pointer"
                      >
